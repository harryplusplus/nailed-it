---
name: memory
description: "Hindsight 장기기억 시스템 스킬입니다. 대화 중 중요한 사실, 절차, 선호, 프로젝트 지식을 발견하면 사용자가 요청하지 않아도 자동으로 저장(retain)하세요. 과거 기억을 찾을 때는 회상(recall), 기억을 종합적으로 분석할 때는 숙고(reflect)하세요. '기억해', '저장해', '이전에 말했던 거 기억나?', '회고', '정리해' 등의 명시적 요청에도 활성화하세요."
license: MIT
